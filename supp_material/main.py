...
from neural_linear_vae import NeuralLinearPosteriorSampling
...
def run_ars(args):
    ...
    wandb.init(project="RepRL", entity="user", config=args.__dict__)
...
if __name__ == '__main__':
    ...
    if args.no_embedding:
        ...
        args.training_freq_network = args.n_directions * 2
    args.training_iter = args.n_directions * 2 * 3
