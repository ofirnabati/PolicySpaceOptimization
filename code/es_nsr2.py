...
class Worker(object):
    ...
    def rollout(self, shift = 0., rollout_length = None):
        ...
        return total_reward, steps, exps
    ...
    def do_rollouts(self, w_policy, num_rollouts = 1, shift = 1, evaluate = False):
        ...
        for i in range(num_rollouts):
            ...
            if evaluate:
                ...
                reward, r_steps, exps = self.rollout(shift = 0., rollout_length=self.rollout_length)
                ...
                pos_reward, pos_steps, pos_exps  = self.rollout(shift = shift)

                # compute reward and number of timesteps used for negative pertubation rollout
                self.policy.update_weights(w_policy - delta)
                neg_reward, neg_steps, neg_exps = self.rollout(shift = shift)
...
class ARSLearner(object):
    ...
    def train(self, num_iter):
        ...
        while self.timesteps <= self.max_timesteps:
            ...
            print('iter ', i,' done')
            self.rollouts += self.num_deltas * 2
