...
folder = '/Users/ofirnabati/Downloads/wandb_csv/appendix_mujoco/'
...
for idx, csv in enumerate(csvs):
    ...
    if env == 'Walker2d-v3' or env == 'Swimmer-v3':
        ax.set_xlim([0,2e6])
...
plt.savefig('/Users/ofirnabati/Documents/PhD/RepRL/figures/mujoco_plots_appendix.png')
# plt.show()
